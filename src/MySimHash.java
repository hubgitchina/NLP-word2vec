...
//		MySimHash hash4 = new MySimHash(s4, 64);
        ...
        MySimHash hash7 = new MySimHash(s7, 64);
        MySimHash hash8 = new MySimHash(s8, 64);
...
//		System.out.println(hash3.getSemblance(hash4));
        ...
        System.out.println("海明距离为："+hash5.hammingDistance(hash6));
        System.out.println("文本相似度为："+hash5.getSemblance(hash6));
        System.out.println("海明距离为："+hash7.hammingDistance(hash8));
        System.out.println("文本相似度为："+hash7.getSemblance(hash8));
		System.out.println("海明距离为："+hash1.hammingDistance(hash2));
